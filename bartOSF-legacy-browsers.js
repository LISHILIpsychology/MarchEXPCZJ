...
flowScheduler.add(end_fishingRoutineBegin());
flowScheduler.add(end_fishingRoutineEachFrame());
flowScheduler.add(end_fishingRoutineEnd());
flowScheduler.add(QUESTION_introRoutineBegin());
flowScheduler.add(QUESTION_introRoutineEachFrame());
flowScheduler.add(QUESTION_introRoutineEnd());
...
flowScheduler.add(Sport7introRoutineBegin());
flowScheduler.add(Sport7introRoutineEachFrame());
flowScheduler.add(Sport7introRoutineEnd());
flowScheduler.add(SportQ1RoutineBegin());
flowScheduler.add(SportQ1RoutineEachFrame());
flowScheduler.add(SportQ1RoutineEnd());
flowScheduler.add(SQ2RoutineBegin());
flowScheduler.add(SQ2RoutineEachFrame());
flowScheduler.add(SQ2RoutineEnd());
flowScheduler.add(SportQ3RoutineBegin());
flowScheduler.add(SportQ3RoutineEachFrame());
flowScheduler.add(SportQ3RoutineEnd());
flowScheduler.add(SQ4RoutineBegin());
flowScheduler.add(SQ4RoutineEachFrame());
flowScheduler.add(SQ4RoutineEnd());
flowScheduler.add(SportQ5RoutineBegin());
flowScheduler.add(SportQ5RoutineEachFrame());
flowScheduler.add(SportQ5RoutineEnd());
flowScheduler.add(Sport6RoutineBegin());
flowScheduler.add(Sport6RoutineEachFrame());
flowScheduler.add(Sport6RoutineEnd());
flowScheduler.add(SportQ7RoutineBegin());
flowScheduler.add(SportQ7RoutineEachFrame());
flowScheduler.add(SportQ7RoutineEnd());
...
flowScheduler.add(endquitRoutineBegin());
flowScheduler.add(endquitRoutineEachFrame());
flowScheduler.add(endquitRoutineEnd());
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'intro/CEXP_welcome.png', 'path': 'intro/CEXP_welcome.png'},
    {'name': 'intro/CEXP_bart_intro.png', 'path': 'intro/CEXP_bart_intro.png'},
    {'name': 'intro/CEXP_practice_bart.png', 'path': 'intro/CEXP_practice_bart.png'},
    ...
    {'name': 'intro/CEXP_questions.png', 'path': 'intro/CEXP_questions.png'},
    {'name': 'intro/EXP_PHQ9_intro_chinese.png', 'path': 'intro/EXP_PHQ9_intro_chinese.png'},
    {'name': 'intro/EXP_loneliness_chinese_intro.png', 'path': 'intro/EXP_loneliness_chinese_intro.png'},
    {'name': 'intro/EXP_BPSQI_intro_chinese.png', 'path': 'intro/EXP_BPSQI_intro_chinese.png'},
    {'name': 'intro/EXP_intro_BMRQ_chinese.png', 'path': 'intro/EXP_intro_BMRQ_chinese.png'},
    {'name': 'intro/EXP_ATAI_intro_chinese.png', 'path': 'intro/EXP_ATAI_intro_chinese.png'},
    {'name': 'intro/EXP_BSSS4_intro_chinese.png', 'path': 'intro/EXP_BSSS4_intro_chinese.png'},
    {'name': 'intro/EXP_uncertainty_chinese_intro.png', 'path': 'intro/EXP_uncertainty_chinese_intro.png'},
    {'name': 'intro/sport7_intro.png', 'path': 'intro/sport7_intro.png'},
    {'name': 'intro/EXP_BPAAT_intro_chinese.png', 'path': 'intro/EXP_BPAAT_intro_chinese.png'},
    {'name': 'CLonelinessQuestion.xlsx', 'path': 'CLonelinessQuestion.xlsx'},
    {'name': 'CPHQ9Question.xlsx', 'path': 'CPHQ9Question.xlsx'},
    {'name': 'CuncertaintyQuestion.xlsx', 'path': 'CuncertaintyQuestion.xlsx'},
    {'name': 'CATAIQUESTIONTEXT.xlsx', 'path': 'CATAIQUESTIONTEXT.xlsx'},
...
var fishcountim_2;
var fishcount_2;
var end_fishingClock;
var background_7;
var exit_button;
var textbox_end;
var text_hint;
var QUESTION_introClock;
...
async function experimentInit() {
  ...
  welcime_chinese_image = new visual.ImageStim({
    ...
    image : 'intro/CEXP_welcome.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  background = new visual.ImageStim({
    ...
    image : 'intro/CEXP_bart_intro.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  background_5 = new visual.ImageStim({
    ...
    image : 'intro/CEXP_practice_bart.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  // Initialize components for Routine "end_fishing"
  end_fishingClock = new util.Clock();
  ...
  text_hint = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_hint',
    text: '请点击下方"进入问卷部分"按钮继续.',
    font: 'Arial',
    units: undefined, 
    pos: [0, (- 0.1)], draggable: false, height: 0.035,  wrapWidth: 1.4, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('black'),  opacity: undefined,
    depth: -3.0 
  });
  
  // Initialize components for Routine "QUESTION_intro"
  QUESTION_introClock = new util.Clock();
  finish_questions_image = new visual.ImageStim({
    win : psychoJS.window,
    name : 'finish_questions_image', units : undefined, 
    image : 'intro/CEXP_questions.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  enter_hint_age = new visual.TextStim({
    win: psychoJS.window,
    name: 'enter_hint_age',
    text: '回答完毕后，请按“回车”键（Enter）进入下一题。\n未完成答题之前，请小心，避免误触回车键（Enter)，导致题目被跳过！！！',
    font: 'Arial',
    units: undefined, 
  ...
  Q_current_practice = new visual.TextStim({
    ...
    text: '20.您目前是否每周至少练习一次乐器/声乐，或在机构/学校担任音乐教师\n并定期授课，或定期参与乐队/合唱团排练与演出？',
    font: 'Arial',
    units: undefined, 
  ...
  PHQ9_intro_image = new visual.ImageStim({
    ...
    image : 'intro/EXP_PHQ9_intro_chinese.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  warningskip = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
    units: undefined, 
    pos: [0, (- 0.35)], draggable: false, height: 0.03,  wrapWidth: 1.8, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('black'),  opacity: undefined,
    depth: -3.0 
  });
  ...
  loneliness_intropic = new visual.ImageStim({
    ...
    image : 'intro/EXP_loneliness_chinese_intro.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  warningskip2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
  ...
  BPSQI_intro_image = new visual.ImageStim({
    ...
    image : 'intro/EXP_BPSQI_intro_chinese.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  Q2_WakeTime = new visual.TextStim({
    win: psychoJS.window,
    name: 'Q2_WakeTime',
    text: '39. 近一个月，通常早上几点起床？ (请填写，例如, 07:00)',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.35], draggable: false, height: 0.05,  wrapWidth: 1.3, ori: 0.0,
    languageStyle: 'LTR',
  ...
  Q4_ActualSleep = new visual.TextStim({
    win: psychoJS.window,
    name: 'Q4_ActualSleep',
    text: '41.近一个月，每夜通常实际睡眠多少小时？（不等于卧床时间）\n',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.35], draggable: false, height: 0.05,  wrapWidth: 1.3, ori: 0.0,
    languageStyle: 'LTR',
  ...
  warningskip2_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_2',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
  ...
  warningskip2_3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_3',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
  ...
  BMRQ_intro_image = new visual.ImageStim({
    ...
    image : 'intro/EXP_intro_BMRQ_chinese.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  warningskip2_4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_4',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
  ...
  ATAI_intro_image = new visual.ImageStim({
    ...
    image : 'intro/EXP_ATAI_intro_chinese.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  warningskip2_5 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_5',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
  ...
  BSSS4_intro_image = new visual.ImageStim({
    ...
    image : 'intro/EXP_BSSS4_intro_chinese.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  warningskip2_6 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_6',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
  ...
  uncertainty_image = new visual.ImageStim({
    ...
    image : 'intro/EXP_uncertainty_chinese_intro.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  uncertainty_slider = new visual.Slider({
    ...
    startValue: undefined,
    size: [1.1, 0.05], pos: [0, 0], ori: 0, units: psychoJS.window.units,
    labels: ["\u6781\u4e0d\u7b26\u5408", "\u4e0d\u7b26\u5408", "\u4e0d\u786e\u5b9a", "\u7b26\u5408", "\u6781\u4e3a\u7b26\u5408"], fontSize: 0.02, ticks: [],
    granularity: 1, style: ["RADIO"],
    color: new util.Color('black'), markerColor: new util.Color('red'), lineColor: new util.Color('black'), 
    opacity: 1, fontFamily: 'Open Sans', bold: true, italic: false, depth: -1, 
    flip: false,
  ...
  warningskip2_7 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_7',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
  ...
  // Initialize components for Routine "Sport7intro"
  Sport7introClock = new util.Clock();
  Sport_image = new visual.ImageStim({
    win : psychoJS.window,
    name : 'Sport_image', units : undefined, 
    image : 'intro/sport7_intro.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  // Initialize components for Routine "SportQ1"
  SportQ1Clock = new util.Clock();
  SportQ1_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'SportQ1_text',
    text: '',
    font: 'Arial',
  ...
  Q1slide = new visual.Slider({
    win: psychoJS.window, name: 'Q1slide',
    startValue: undefined,
    size: [1.1, 0.05], pos: [0, 0], ori: 0, units: psychoJS.window.units,
    labels: ["0\u5929", "1\u5929", "2\u5929", "3\u5929", "4\u5929", "5\u5929", "6\u5929", "7\u5929"], fontSize: 0.02, ticks: [],
    granularity: 1, style: ["RADIO"],
    color: new util.Color('black'), markerColor: new util.Color('red'), lineColor: new util.Color('black'), 
    opacity: 1, fontFamily: 'Open Sans', bold: true, italic: false, depth: -1, 
    flip: false,
  ...
  warningskip2_10 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_10',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
    units: undefined, 
    pos: [0, (- 0.35)], draggable: false, height: 0.03,  wrapWidth: 1.8, ori: 0.0,
  ...
  // Initialize components for Routine "SQ2"
  SQ2Clock = new util.Clock();
  SQQ2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'SQQ2',
    text: '90.在这其中一天您通常会花多少分钟在剧烈的体育活动上?\n像是提重物、挖掘、有氧运动或是快速骑车。\n（分钟）',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.35], draggable: false, height: 0.05,  wrapWidth: 1.3, ori: 0.0,
    languageStyle: 'LTR',
  ...
  textbox_Q2sports = new visual.TextBox({
    win: psychoJS.window,
    name: 'textbox_Q2sports',
    text: '',
  ...
  enter_hint_11 = new visual.TextStim({
    win: psychoJS.window,
    name: 'enter_hint_11',
    text: '回答完毕后，请按回车键继续。\n未完成答题之前，请小心，避免误触回车键（Enter)，导致题目被跳过！！！',
    font: 'Arial',
  ...
  // Initialize components for Routine "SportQ3"
  SportQ3Clock = new util.Clock();
  SportQ3_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'SportQ3_text',
    text: '',
    font: 'Arial',
  ...
  Q3slide = new visual.Slider({
    win: psychoJS.window, name: 'Q3slide',
    startValue: undefined,
    size: [1.1, 0.05], pos: [0, 0], ori: 0, units: psychoJS.window.units,
    labels: ["0\u5929", "1\u5929", "2\u5929", "3\u5929", "4\u5929", "5\u5929", "6\u5929", "7\u5929"], fontSize: 0.02, ticks: [],
    granularity: 1, style: ["RADIO"],
  ...
  warningskip2_11 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_11',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
    units: undefined, 
    pos: [0, (- 0.35)], draggable: false, height: 0.03,  wrapWidth: 1.8, ori: 0.0,
  ...
  // Initialize components for Routine "SQ4"
  SQ4Clock = new util.Clock();
  Q4sports = new visual.TextStim({
    win: psychoJS.window,
    name: 'Q4sports',
    text: '92.在这其中一天您通常会花多少分钟在适度的体育活动上?\n\n像是提轻的物品、以平常的速度骑车或打双人网球\n请不要包括走路。\n（分钟）',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.27], draggable: false, height: 0.04,  wrapWidth: 1.3, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('black'),  opacity: undefined,
    depth: 0.0 
  });
  
  textbox_Q4sportss = new visual.TextBox({
    win: psychoJS.window,
    name: 'textbox_Q4sportss',
    text: '',
    placeholder: undefined,
    font: 'Arial',
    pos: [0, 0], 
  ...
  enter_hint_12 = new visual.TextStim({
    win: psychoJS.window,
    name: 'enter_hint_12',
    text: '回答完毕后，请按回车键继续。\n未完成答题之前，请小心，避免误触回车键（Enter)，导致题目被跳过！！！',
    font: 'Arial',
  ...
  // Initialize components for Routine "SportQ5"
  SportQ5Clock = new util.Clock();
  Q5sport = new visual.TextStim({
    win: psychoJS.window,
    name: 'Q5sport',
    text: '93.最近7天内，您有几天是步行，且一次步行至少10分钟?\n',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.35], draggable: false, height: 0.05,  wrapWidth: 1.3, ori: 0.0,
    languageStyle: 'LTR',
  ...
  Q3slide_2 = new visual.Slider({
    win: psychoJS.window, name: 'Q3slide_2',
    startValue: undefined,
    size: [1.1, 0.05], pos: [0, 0], ori: 0, units: psychoJS.window.units,
    labels: ["0\u5929", "1\u5929", "2\u5929", "3\u5929", "4\u5929", "5\u5929", "6\u5929", "7\u5929"], fontSize: 0.02, ticks: [],
    granularity: 1, style: ["RADIO"],
  ...
  // Initialize components for Routine "Sport6"
  Sport6Clock = new util.Clock();
  Q6sport = new visual.TextStim({
    win: psychoJS.window,
    name: 'Q6sport',
    text: '94.在这其中每一天您通常花多少分钟在步行上?\n（分钟）\n',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.35], draggable: false, height: 0.05,  wrapWidth: 1.3, ori: 0.0,
    languageStyle: 'LTR',
  ...
  textbox_Q6sport = new visual.TextBox({
    win: psychoJS.window,
    name: 'textbox_Q6sport',
    text: '',
    placeholder: undefined,
    font: 'Arial',
    pos: [0, 0], 
  ...
  // Initialize components for Routine "SportQ7"
  SportQ7Clock = new util.Clock();
  Q7sport = new visual.TextStim({
    win: psychoJS.window,
    name: 'Q7sport',
    text: '95.最近七天内，每个工作日您平均有多少小时是坐着的?\n（小时）\n',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.35], draggable: false, height: 0.05,  wrapWidth: 1.3, ori: 0.0,
    languageStyle: 'LTR',
  ...
  textbox_Q7sport = new visual.TextBox({
    win: psychoJS.window,
    name: 'textbox_Q7sport',
    text: '',
    placeholder: undefined,
    font: 'Arial',
    pos: [0, 0], 
  ...
  enter_hint_9 = new visual.TextStim({
    win: psychoJS.window,
    name: 'enter_hint_9',
    text: '回答完毕后，请按回车键继续。\n未完成答题之前，请小心，避免误触回车键（Enter)，导致题目被跳过！！！',
    font: 'Arial',
  ...
  BPAAT_intro_image = new visual.ImageStim({
    ...
    image : 'intro/EXP_BPAAT_intro_chinese.png', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  BPAAT_questiontext1 = new visual.TextStim({
    ...
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.3], draggable: false, height: 0.04,  wrapWidth: 1.0, ori: 0,
    languageStyle: 'LTR',
    color: new util.Color('black'),  opacity: 1,
    depth: 0.0 
  });
  ...
  warningskip2_8 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_8',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
  ...
  warningskip2_9 = new visual.TextStim({
    win: psychoJS.window,
    name: 'warningskip2_9',
    text: '请准确的点击“圆点”位置！！！\n若不小心点击到“空白区域”，系统会自动选择最近的“圆点”选项，随后自动跳转到下一题！！！\n不可返回再作答！',
    font: 'Arial',
  ...
  // Initialize components for Routine "endquit"
  endquitClock = new util.Clock();
  background_8 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'background_8', units : 'norm', 
    image : 'images/lake5.jpg', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
  ...
  textbox_end_2 = new visual.TextBox({
    win: psychoJS.window,
    name: 'textbox_end_2',
    text: '',
    placeholder: 'Type here...',
  ...
  text_hint_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_hint_2',
    text: '按"退出"后，待页面跳转，随后再等待1分钟\n看到"Thank you for your patience. Goodbye!" 后，再点击"OK"结束实验！\n\n切勿按其他键或强制关闭窗口，否则数据将无法保存！',
    font: 'Arial',
    units: undefined, 
    pos: [0, (- 0.1)], draggable: false, height: 0.035,  wrapWidth: 1.4, ori: 0.0,
    languageStyle: 'LTR',
...
function practice_introRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_introComponents.push(background_5);
...
var end_fishingMaxDurationReached;
var end_fishingMaxDuration;
var end_fishingComponents;
function end_fishingRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'end_fishing' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    end_fishingClock.reset();
    routineTimer.reset();
    end_fishingMaxDurationReached = false;
    // update component parameters for each repeat
    // reset exit_button to account for continued clicks & clear times on/off
    exit_button.reset()
    textbox_end.setText((("\u6e38\u620f\u7ed3\u675f\uff01\n\u4f60\u4e00\u5171\u9493\u5230  " + nfish.toString()) + "  \u6761\u9c7c\uff01"));
    psychoJS.experiment.addData('end_fishing.started', globalClock.getTime());
    end_fishingMaxDuration = null
    // keep track of which components have finished
    end_fishingComponents = [];
    end_fishingComponents.push(background_7);
    end_fishingComponents.push(exit_button);
    end_fishingComponents.push(textbox_end);
    end_fishingComponents.push(text_hint);
    
    end_fishingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function end_fishingRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'end_fishing' ---
    // get current time
    t = end_fishingClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    ...
    if (background_7.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (exit_button.status === PsychoJS.Status.STARTED) {
      ...
      if (exit_button.isClicked) {
        ...
        if (!exit_button.wasClicked) {
          ...
          continueRoutine = false;
          psychoJS.experiment.addData("quit", "\u9493\u9c7c\u6e38\u620f\u7ed3\u675f");
        }
    ...
    // if textbox_end is active this frame...
    if (textbox_end.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *text_hint* updates
    if (t >= 0.0 && text_hint.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      text_hint.tStart = t;  // (not accounting for frame time here)
      text_hint.frameNStart = frameN;  // exact frame index
      
      text_hint.setAutoDraw(true);
    }
    
    
    // if text_hint is active this frame...
    if (text_hint.status === PsychoJS.Status.STARTED) {
    }
...
function end_fishingRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'end_fishing' ---
    end_fishingComponents.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    });
    psychoJS.experiment.addData('end_fishing.stopped', globalClock.getTime());
    ...
    // the Routine "end_fishing" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
var QUESTION_introMaxDurationReached;
var _resp_2_allKeys;
var QUESTION_introMaxDuration;
var QUESTION_introComponents;
function QUESTION_introRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'QUESTION_intro' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    QUESTION_introClock.reset();
    routineTimer.reset();
    QUESTION_introMaxDurationReached = false;
    // update component parameters for each repeat
    resp_2.keys = undefined;
    resp_2.rt = undefined;
    _resp_2_allKeys = [];
    psychoJS.experiment.addData('QUESTION_intro.started', globalClock.getTime());
    QUESTION_introMaxDuration = null
    // keep track of which components have finished
    QUESTION_introComponents = [];
    QUESTION_introComponents.push(finish_questions_image);
    QUESTION_introComponents.push(resp_2);
    
    QUESTION_introComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function QUESTION_introRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'QUESTION_intro' ---
    // get current time
    t = QUESTION_introClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
...
function QUESTION_introRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'QUESTION_intro' ---
    QUESTION_introComponents.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    });
    psychoJS.experiment.addData('QUESTION_intro.stopped', globalClock.getTime());
    resp_2.stop();
    // the Routine "QUESTION_intro" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
function religionRoutineEachFrame() {
  return async function () {
    ...
    // *QQ5* updates
    if (t >= 0.0 && QQ5.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      QQ5.tStart = t;  // (not accounting for frame time here)
      QQ5.frameNStart = frameN;  // exact frame index
      
      QQ5.setAutoDraw(true);
    }
    
    
    // if QQ5 is active this frame...
    if (QQ5.status === PsychoJS.Status.STARTED) {
    }
...
function family_incomeRoutineBegin(snapshot) {
  return async function () {
    ...
    family_incomeComponents.push(Q6);
...
function heightRoutineEachFrame() {
  return async function () {
    ...
    // *QQ7* updates
    if (t >= 0.0 && QQ7.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      QQ7.tStart = t;  // (not accounting for frame time here)
      QQ7.frameNStart = frameN;  // exact frame index
      
      QQ7.setAutoDraw(true);
    }
    
    
    // if QQ7 is active this frame...
    if (QQ7.status === PsychoJS.Status.STARTED) {
    }
...
function weightRoutineEachFrame() {
  return async function () {
    ...
    // *QQ8* updates
    if (t >= 0.0 && QQ8.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      QQ8.tStart = t;  // (not accounting for frame time here)
      QQ8.frameNStart = frameN;  // exact frame index
      
      QQ8.setAutoDraw(true);
    }
    
    
    // if QQ8 is active this frame...
    if (QQ8.status === PsychoJS.Status.STARTED) {
    }
...
function waistlineRoutineEachFrame() {
  return async function () {
    ...
    // *QQ9* updates
    if (t >= 0.0 && QQ9.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      QQ9.tStart = t;  // (not accounting for frame time here)
      QQ9.frameNStart = frameN;  // exact frame index
      
      QQ9.setAutoDraw(true);
    }
    
    
    // if QQ9 is active this frame...
    if (QQ9.status === PsychoJS.Status.STARTED) {
    }
...
function ever_drink_alcoholRoutineBegin(snapshot) {
  return async function () {
    ...
    ever_drink_alcoholComponents.push(Q10);
...
function last_drink_timeRoutineBegin(snapshot) {
  return async function () {
    ...
    last_drink_timeComponents.push(Q11);
...
function drink_freq_12mo_2RoutineBegin(snapshot) {
  return async function () {
    ...
    drink_freq_12mo_2Components.push(Q12);
...
function drink_amount_12moRoutineBegin(snapshot) {
  return async function () {
    ...
    drink_amount_12moComponents.push(Q13);
...
function start_smoke_ageRoutineBegin(snapshot) {
  return async function () {
    ...
    start_smoke_ageComponents.push(Q15);
...
function cigs_per_dayRoutineBegin(snapshot) {
  return async function () {
    ...
    cigs_per_dayComponents.push(Q16);
...
function self_health_statusRoutineBegin(snapshot) {
  return async function () {
    ...
    self_health_statusComponents.push(Q17);
...
function hearing_statusRoutineBegin(snapshot) {
  return async function () {
    ...
    hearing_statusComponents.push(Q18);
...
function music_trainingRoutineBegin(snapshot) {
  return async function () {
    ...
    music_trainingComponents.push(Q19);
...
function current_practiceRoutineBegin(snapshot) {
  return async function () {
    ...
    current_practiceComponents.push(Q20);
...
function PHQ_9RoutineBegin(snapshot) {
  return async function () {
    ...
    PHQ_9Components.push(Q21toQ29);
    PHQ_9Components.push(warningskip);
...
function PHQ_9RoutineEachFrame() {
  return async function () {
    ...
    // *Q21toQ29* updates
    if (t >= 0.0 && Q21toQ29.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q21toQ29.tStart = t;  // (not accounting for frame time here)
      Q21toQ29.frameNStart = frameN;  // exact frame index
      
      Q21toQ29.setAutoDraw(true);
    }
    
    
    // if Q21toQ29 is active this frame...
    if (Q21toQ29.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *warningskip* updates
    if (t >= 0.0 && warningskip.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip.tStart = t;  // (not accounting for frame time here)
      warningskip.frameNStart = frameN;  // exact frame index
      
      warningskip.setAutoDraw(true);
    }
    
    
    // if warningskip is active this frame...
    if (warningskip.status === PsychoJS.Status.STARTED) {
    }
...
function lonelinessRoutineBegin(snapshot) {
  return async function () {
    ...
    Q30toQ37.setText(lonelinessqIndex);
    ...
    lonelinessComponents.push(Q30toQ37);
    lonelinessComponents.push(warningskip2);
...
function lonelinessRoutineEachFrame() {
  return async function () {
    ...
    // *Q30toQ37* updates
    if (t >= 0.0 && Q30toQ37.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q30toQ37.tStart = t;  // (not accounting for frame time here)
      Q30toQ37.frameNStart = frameN;  // exact frame index
      
      Q30toQ37.setAutoDraw(true);
    }
    
    
    // if Q30toQ37 is active this frame...
    if (Q30toQ37.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *warningskip2* updates
    if (t >= 0.0 && warningskip2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2.tStart = t;  // (not accounting for frame time here)
      warningskip2.frameNStart = frameN;  // exact frame index
      
      warningskip2.setAutoDraw(true);
    }
    
    
    // if warningskip2 is active this frame...
    if (warningskip2.status === PsychoJS.Status.STARTED) {
    }
...
function B_PSQI_Q1_BedTimeRoutineBegin(snapshot) {
  return async function () {
    ...
    B_PSQI_Q1_BedTimeComponents.push(Q38);
...
function B_PSQI_Q2_WakeTimeRoutineBegin(snapshot) {
  return async function () {
    ...
    B_PSQI_Q2_WakeTimeComponents.push(Q39);
...
function B_PSQI_Q3_SleepLatencyRoutineBegin(snapshot) {
  return async function () {
    ...
    B_PSQI_Q3_SleepLatencyComponents.push(Q40);
...
function B_PSQI_Q4_ActualSleepRoutineBegin(snapshot) {
  return async function () {
    ...
    B_PSQI_Q4_ActualSleepComponents.push(Q41);
...
function B_PSQI5RoutineBegin(snapshot) {
  return async function () {
    ...
    B_PSQI5Components.push(Q42);
    B_PSQI5Components.push(warningskip2_2);
...
function B_PSQI5RoutineEachFrame() {
  return async function () {
    ...
    // *warningskip2_2* updates
    if (t >= 0.0 && warningskip2_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_2.tStart = t;  // (not accounting for frame time here)
      warningskip2_2.frameNStart = frameN;  // exact frame index
      
      warningskip2_2.setAutoDraw(true);
    }
    
    
    // if warningskip2_2 is active this frame...
    if (warningskip2_2.status === PsychoJS.Status.STARTED) {
    }
...
function B_PSQI6RoutineBegin(snapshot) {
  return async function () {
    ...
    B_PSQI6Components.push(Q43);
    B_PSQI6Components.push(warningskip2_3);
...
function B_PSQI6RoutineEachFrame() {
  return async function () {
    ...
    // *warningskip2_3* updates
    if (t >= 0.0 && warningskip2_3.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_3.tStart = t;  // (not accounting for frame time here)
      warningskip2_3.frameNStart = frameN;  // exact frame index
      
      warningskip2_3.setAutoDraw(true);
    }
    
    
    // if warningskip2_3 is active this frame...
    if (warningskip2_3.status === PsychoJS.Status.STARTED) {
    }
...
function BMRQRoutineBegin(snapshot) {
  return async function () {
    ...
    BMRQComponents.push(Q44toQ63);
    BMRQComponents.push(warningskip2_4);
...
function BMRQRoutineEachFrame() {
  return async function () {
    ...
    // *Q44toQ63* updates
    if (t >= 0.0 && Q44toQ63.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q44toQ63.tStart = t;  // (not accounting for frame time here)
      Q44toQ63.frameNStart = frameN;  // exact frame index
      
      Q44toQ63.setAutoDraw(true);
    }
    
    
    // if Q44toQ63 is active this frame...
    if (Q44toQ63.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *warningskip2_4* updates
    if (t >= 0.0 && warningskip2_4.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_4.tStart = t;  // (not accounting for frame time here)
      warningskip2_4.frameNStart = frameN;  // exact frame index
      
      warningskip2_4.setAutoDraw(true);
    }
    
    
    // if warningskip2_4 is active this frame...
    if (warningskip2_4.status === PsychoJS.Status.STARTED) {
    }
...
function ATAI_QRoutineBegin(snapshot) {
  return async function () {
    ...
    ATAI_QComponents.push(Q64toQ68);
    ATAI_QComponents.push(warningskip2_5);
...
function ATAI_QRoutineEachFrame() {
  return async function () {
    ...
    // *Q64toQ68* updates
    if (t >= 0.0 && Q64toQ68.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q64toQ68.tStart = t;  // (not accounting for frame time here)
      Q64toQ68.frameNStart = frameN;  // exact frame index
      
      Q64toQ68.setAutoDraw(true);
    }
    
    
    // if Q64toQ68 is active this frame...
    if (Q64toQ68.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *warningskip2_5* updates
    if (t >= 0.0 && warningskip2_5.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_5.tStart = t;  // (not accounting for frame time here)
      warningskip2_5.frameNStart = frameN;  // exact frame index
      
      warningskip2_5.setAutoDraw(true);
    }
    
    
    // if warningskip2_5 is active this frame...
    if (warningskip2_5.status === PsychoJS.Status.STARTED) {
    }
...
function BSSSRoutineBegin(snapshot) {
  return async function () {
    ...
    BSSSComponents.push(Q69toQ76);
    BSSSComponents.push(warningskip2_6);
...
function BSSSRoutineEachFrame() {
  return async function () {
    ...
    // *Q69toQ76* updates
    if (t >= 0.0 && Q69toQ76.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q69toQ76.tStart = t;  // (not accounting for frame time here)
      Q69toQ76.frameNStart = frameN;  // exact frame index
      
      Q69toQ76.setAutoDraw(true);
    }
    
    
    // if Q69toQ76 is active this frame...
    if (Q69toQ76.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *warningskip2_6* updates
    if (t >= 0.0 && warningskip2_6.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_6.tStart = t;  // (not accounting for frame time here)
      warningskip2_6.frameNStart = frameN;  // exact frame index
      
      warningskip2_6.setAutoDraw(true);
    }
    
    
    // if warningskip2_6 is active this frame...
    if (warningskip2_6.status === PsychoJS.Status.STARTED) {
    }
...
function uncertainty_introRoutineEachFrame() {
  return async function () {
    ...
    if (key_resp_16.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_16.getKeys({keyList: 'return', waitRelease: false});
...
function uncertaintyRoutineBegin(snapshot) {
  return async function () {
    ...
    Q77toQ88.setText(uncertaintyqIndex);
    ...
    uncertaintyComponents.push(Q77toQ88);
    uncertaintyComponents.push(warningskip2_7);
...
function uncertaintyRoutineEachFrame() {
  return async function () {
    ...
    // *Q77toQ88* updates
    if (t >= 0.0 && Q77toQ88.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q77toQ88.tStart = t;  // (not accounting for frame time here)
      Q77toQ88.frameNStart = frameN;  // exact frame index
      
      Q77toQ88.setAutoDraw(true);
    }
    
    
    // if Q77toQ88 is active this frame...
    if (Q77toQ88.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *warningskip2_7* updates
    if (t >= 0.0 && warningskip2_7.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_7.tStart = t;  // (not accounting for frame time here)
      warningskip2_7.frameNStart = frameN;  // exact frame index
      
      warningskip2_7.setAutoDraw(true);
    }
    
    
    // if warningskip2_7 is active this frame...
    if (warningskip2_7.status === PsychoJS.Status.STARTED) {
    }
...
var Sport7introMaxDurationReached;
var _key_resp_12_allKeys;
var Sport7introMaxDuration;
var Sport7introComponents;
function Sport7introRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'Sport7intro' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    Sport7introClock.reset();
    routineTimer.reset();
    Sport7introMaxDurationReached = false;
    // update component parameters for each repeat
    key_resp_12.keys = undefined;
    key_resp_12.rt = undefined;
    _key_resp_12_allKeys = [];
    psychoJS.experiment.addData('Sport7intro.started', globalClock.getTime());
    Sport7introMaxDuration = null
    // keep track of which components have finished
    Sport7introComponents = [];
    Sport7introComponents.push(Sport_image);
    Sport7introComponents.push(key_resp_12);
    
    Sport7introComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Sport7introRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'Sport7intro' ---
    // get current time
    t = Sport7introClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    ...
    // if Sport_image is active this frame...
    if (Sport_image.status === PsychoJS.Status.STARTED) {
    }
...
function Sport7introRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'Sport7intro' ---
    Sport7introComponents.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    });
    psychoJS.experiment.addData('Sport7intro.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
    ...
    key_resp_12.stop();
    // the Routine "Sport7intro" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
var SportQ1MaxDurationReached;
var SportQ1MaxDuration;
var SportQ1Components;
function SportQ1RoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'SportQ1' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    ...
    SportQ1Clock.reset();
    routineTimer.reset();
    SportQ1MaxDurationReached = false;
    // update component parameters for each repeat
    SportQ1_text.setText('89.最近7天内，您有几天做了剧烈的体育活动，\n像是提重物、挖掘、有氧运动或是快速骑车?\n');
    Q1slide.reset()
    QQ89.setText('第 89 题，共 97 题');
    psychoJS.experiment.addData('SportQ1.started', globalClock.getTime());
    SportQ1MaxDuration = null
    // keep track of which components have finished
    SportQ1Components = [];
    SportQ1Components.push(SportQ1_text);
    SportQ1Components.push(Q1slide);
    SportQ1Components.push(QQ89);
    SportQ1Components.push(warningskip2_10);
    
    SportQ1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SportQ1RoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'SportQ1' ---
    // get current time
    t = SportQ1Clock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    
    // *SportQ1_text* updates
    if (t >= 0.0 && SportQ1_text.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      SportQ1_text.tStart = t;  // (not accounting for frame time here)
      SportQ1_text.frameNStart = frameN;  // exact frame index
      
      SportQ1_text.setAutoDraw(true);
    }
    
    
    // if SportQ1_text is active this frame...
    if (SportQ1_text.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *Q1slide* updates
    if (t >= 0.0 && Q1slide.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q1slide.tStart = t;  // (not accounting for frame time here)
      Q1slide.frameNStart = frameN;  // exact frame index
      
      Q1slide.setAutoDraw(true);
    }
    
    
    // if Q1slide is active this frame...
    if (Q1slide.status === PsychoJS.Status.STARTED) {
    }
    
    
    // Check Q1slide for response to end Routine
    if (Q1slide.getRating() !== undefined && Q1slide.status === PsychoJS.Status.STARTED) {
      continueRoutine = false; }
    
    // *QQ89* updates
    if (t >= 0.0 && QQ89.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      QQ89.tStart = t;  // (not accounting for frame time here)
      QQ89.frameNStart = frameN;  // exact frame index
      
      QQ89.setAutoDraw(true);
    }
    
    
    // if QQ89 is active this frame...
    if (QQ89.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *warningskip2_10* updates
    if (t >= 0.0 && warningskip2_10.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_10.tStart = t;  // (not accounting for frame time here)
      warningskip2_10.frameNStart = frameN;  // exact frame index
      
      warningskip2_10.setAutoDraw(true);
    }
    
    
    // if warningskip2_10 is active this frame...
    if (warningskip2_10.status === PsychoJS.Status.STARTED) {
    }
...
function SportQ1RoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'SportQ1' ---
    SportQ1Components.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    });
    psychoJS.experiment.addData('SportQ1.stopped', globalClock.getTime());
    psychoJS.experiment.addData('Q1slide.response', Q1slide.getRating());
    psychoJS.experiment.addData('Q1slide.rt', Q1slide.getRT());
    // the Routine "SportQ1" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
var SQ2MaxDurationReached;
var SQ2MaxDuration;
var SQ2Components;
function SQ2RoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'SQ2' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    ...
    SQ2Clock.reset();
    routineTimer.reset();
    SQ2MaxDurationReached = false;
    // update component parameters for each repeat
    textbox_Q2sports.setText('');
    textbox_Q2sports.refresh();
    QQ90.setText('第 90 题，共 97 题');
    psychoJS.experiment.addData('SQ2.started', globalClock.getTime());
    SQ2MaxDuration = null
    // keep track of which components have finished
    SQ2Components = [];
    SQ2Components.push(SQQ2);
    SQ2Components.push(textbox_Q2sports);
    SQ2Components.push(enter_hint_11);
    SQ2Components.push(QQ90);
    
    SQ2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SQ2RoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'SQ2' ---
    // get current time
    t = SQ2Clock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    ...
    // *SQQ2* updates
    if (t >= 0.0 && SQQ2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      SQQ2.tStart = t;  // (not accounting for frame time here)
      SQQ2.frameNStart = frameN;  // exact frame index
      
      SQQ2.setAutoDraw(true);
    }
    
    
    // if SQQ2 is active this frame...
    if (SQQ2.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *textbox_Q2sports* updates
    if (t >= 0.0 && textbox_Q2sports.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      textbox_Q2sports.tStart = t;  // (not accounting for frame time here)
      textbox_Q2sports.frameNStart = frameN;  // exact frame index
      
      textbox_Q2sports.setAutoDraw(true);
    }
    
    
    // if textbox_Q2sports is active this frame...
    if (textbox_Q2sports.status === PsychoJS.Status.STARTED) {
    }
    
    // Run 'Each Frame' code from code_Q2sports
    var _pj;
    function _pj_snippets(container) {
        function in_es6(left, right) {
            if (((right instanceof Array) || ((typeof right) === "string"))) {
    ...
    _pj = {};
    _pj_snippets(_pj);
    if ((! ("allow_advance_Q2_sport" in psychoJS.experiment))) {
        psychoJS.experiment.allow_advance_Q2_sport = false;
    }
    keys = psychoJS.eventManager.getKeys();
    if (_pj.in_es6("return", keys)) {
        user_input = textbox_Q2sports.text.trim();
        if ((user_input !== "")) {
            psychoJS.experiment.allow_advance_Q2_sport = true;
        }
    }
    if (psychoJS.experiment.allow_advance_Q2_sport) {
        continueRoutine = false;
    }
    
    
    // *enter_hint_11* updates
    if (t >= 0.0 && enter_hint_11.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      enter_hint_11.tStart = t;  // (not accounting for frame time here)
      enter_hint_11.frameNStart = frameN;  // exact frame index
      
      enter_hint_11.setAutoDraw(true);
    }
    
    
    // if enter_hint_11 is active this frame...
    if (enter_hint_11.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *QQ90* updates
    if (t >= 0.0 && QQ90.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      QQ90.tStart = t;  // (not accounting for frame time here)
      QQ90.frameNStart = frameN;  // exact frame index
      
      QQ90.setAutoDraw(true);
    }
    
    
    // if QQ90 is active this frame...
    if (QQ90.status === PsychoJS.Status.STARTED) {
    }
...
function SQ2RoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'SQ2' ---
    SQ2Components.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
    ...
    psychoJS.experiment.addData('SQ2.stopped', globalClock.getTime());
    psychoJS.experiment.addData('textbox_Q2sports.text',textbox_Q2sports.text)
    // Run 'End Routine' code from code_Q2sports
    psychoJS.experiment.addData("Q2_sport", textbox_Q2sports.text);
    
    // the Routine "SQ2" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
var SportQ3MaxDurationReached;
var SportQ3MaxDuration;
var SportQ3Components;
function SportQ3RoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'SportQ3' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    ...
    SportQ3Clock.reset();
    routineTimer.reset();
    SportQ3MaxDurationReached = false;
    // update component parameters for each repeat
    SportQ3_text.setText('91.最近7天内，您有几天做了适度的体育活动，\n像是提轻的物品、以平常的速度骑车或打双人网球?\n请不要包括走路。');
    Q3slide.reset()
    QQ91.setText('第 91 题，共 97 题');
    psychoJS.experiment.addData('SportQ3.started', globalClock.getTime());
    SportQ3MaxDuration = null
    // keep track of which components have finished
    SportQ3Components = [];
    SportQ3Components.push(SportQ3_text);
    SportQ3Components.push(Q3slide);
    SportQ3Components.push(QQ91);
    SportQ3Components.push(warningskip2_11);
    
    SportQ3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SportQ3RoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'SportQ3' ---
    // get current time
    t = SportQ3Clock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    
    // *SportQ3_text* updates
    if (t >= 0.0 && SportQ3_text.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      SportQ3_text.tStart = t;  // (not accounting for frame time here)
      SportQ3_text.frameNStart = frameN;  // exact frame index
      
      SportQ3_text.setAutoDraw(true);
    }
    
    
    // if SportQ3_text is active this frame...
    if (SportQ3_text.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *Q3slide* updates
    if (t >= 0.0 && Q3slide.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q3slide.tStart = t;  // (not accounting for frame time here)
      Q3slide.frameNStart = frameN;  // exact frame index
      
      Q3slide.setAutoDraw(true);
    }
    
    
    // if Q3slide is active this frame...
    if (Q3slide.status === PsychoJS.Status.STARTED) {
    }
    
    
    // Check Q3slide for response to end Routine
    if (Q3slide.getRating() !== undefined && Q3slide.status === PsychoJS.Status.STARTED) {
      continueRoutine = false; }
    
    // *QQ91* updates
    if (t >= 0.0 && QQ91.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      QQ91.tStart = t;  // (not accounting for frame time here)
      QQ91.frameNStart = frameN;  // exact frame index
      
      QQ91.setAutoDraw(true);
    }
    
    
    // if QQ91 is active this frame...
    if (QQ91.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *warningskip2_11* updates
    if (t >= 0.0 && warningskip2_11.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_11.tStart = t;  // (not accounting for frame time here)
      warningskip2_11.frameNStart = frameN;  // exact frame index
      
      warningskip2_11.setAutoDraw(true);
    }
    
    
    // if warningskip2_11 is active this frame...
    if (warningskip2_11.status === PsychoJS.Status.STARTED) {
    }
...
function SportQ3RoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'SportQ3' ---
    SportQ3Components.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    });
    psychoJS.experiment.addData('SportQ3.stopped', globalClock.getTime());
    psychoJS.experiment.addData('Q3slide.response', Q3slide.getRating());
    psychoJS.experiment.addData('Q3slide.rt', Q3slide.getRT());
    // the Routine "SportQ3" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
var SQ4MaxDurationReached;
var SQ4MaxDuration;
var SQ4Components;
function SQ4RoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'SQ4' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    ...
    SQ4Clock.reset();
    routineTimer.reset();
    SQ4MaxDurationReached = false;
    // update component parameters for each repeat
    textbox_Q4sportss.setText('');
    textbox_Q4sportss.refresh();
    Q92.setText('第 92 题，共 97 题');
    psychoJS.experiment.addData('SQ4.started', globalClock.getTime());
    SQ4MaxDuration = null
    // keep track of which components have finished
    SQ4Components = [];
    SQ4Components.push(Q4sports);
    SQ4Components.push(textbox_Q4sportss);
    SQ4Components.push(enter_hint_12);
    SQ4Components.push(Q92);
    
    SQ4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SQ4RoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'SQ4' ---
    // get current time
    t = SQ4Clock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    ...
    // *Q4sports* updates
    if (t >= 0.0 && Q4sports.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q4sports.tStart = t;  // (not accounting for frame time here)
      Q4sports.frameNStart = frameN;  // exact frame index
      
      Q4sports.setAutoDraw(true);
    }
    
    
    // if Q4sports is active this frame...
    if (Q4sports.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *textbox_Q4sportss* updates
    if (t >= 0.0 && textbox_Q4sportss.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      textbox_Q4sportss.tStart = t;  // (not accounting for frame time here)
      textbox_Q4sportss.frameNStart = frameN;  // exact frame index
      
      textbox_Q4sportss.setAutoDraw(true);
    }
    
    
    // if textbox_Q4sportss is active this frame...
    if (textbox_Q4sportss.status === PsychoJS.Status.STARTED) {
    }
    
    // Run 'Each Frame' code from code_Q4sportss
    var _pj;
    function _pj_snippets(container) {
        function in_es6(left, right) {
            if (((right instanceof Array) || ((typeof right) === "string"))) {
    ...
    _pj = {};
    _pj_snippets(_pj);
    if ((! ("allow_advance_Q4_sport" in psychoJS.experiment))) {
        psychoJS.experiment.allow_advance_Q4_sport = false;
    }
    keys = psychoJS.eventManager.getKeys();
    if (_pj.in_es6("return", keys)) {
        user_input = textbox_Q4sportss.text.trim();
        if ((user_input !== "")) {
            psychoJS.experiment.allow_advance_Q4_sport = true;
        }
    }
    if (psychoJS.experiment.allow_advance_Q4_sport) {
        continueRoutine = false;
    }
    
    
    // *enter_hint_12* updates
    if (t >= 0.0 && enter_hint_12.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      enter_hint_12.tStart = t;  // (not accounting for frame time here)
      enter_hint_12.frameNStart = frameN;  // exact frame index
      
      enter_hint_12.setAutoDraw(true);
    }
    
    
    // if enter_hint_12 is active this frame...
    if (enter_hint_12.status === PsychoJS.Status.STARTED) {
    }
...
function SQ4RoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'SQ4' ---
    SQ4Components.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
    ...
    psychoJS.experiment.addData('SQ4.stopped', globalClock.getTime());
    psychoJS.experiment.addData('textbox_Q4sportss.text',textbox_Q4sportss.text)
    // Run 'End Routine' code from code_Q4sportss
    psychoJS.experiment.addData("Q4_sport", textbox_Q4sportss.text);
    
    // the Routine "SQ4" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
var SportQ5MaxDurationReached;
var SportQ5MaxDuration;
var SportQ5Components;
function SportQ5RoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'SportQ5' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    ...
    SportQ5Clock.reset();
    routineTimer.reset();
    SportQ5MaxDurationReached = false;
    // update component parameters for each repeat
    Q3slide_2.reset()
    QQ93.setText('第 93 题，共 97 题');
    psychoJS.experiment.addData('SportQ5.started', globalClock.getTime());
    SportQ5MaxDuration = null
    // keep track of which components have finished
    SportQ5Components = [];
    SportQ5Components.push(Q5sport);
    SportQ5Components.push(Q3slide_2);
    SportQ5Components.push(enter_hint_7);
    SportQ5Components.push(QQ93);
    
    SportQ5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SportQ5RoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'SportQ5' ---
    // get current time
    t = SportQ5Clock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    
    // *Q5sport* updates
    if (t >= 0.0 && Q5sport.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q5sport.tStart = t;  // (not accounting for frame time here)
      Q5sport.frameNStart = frameN;  // exact frame index
      
      Q5sport.setAutoDraw(true);
    }
    
    
    // if Q5sport is active this frame...
    if (Q5sport.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *Q3slide_2* updates
    if (t >= 0.0 && Q3slide_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q3slide_2.tStart = t;  // (not accounting for frame time here)
      Q3slide_2.frameNStart = frameN;  // exact frame index
      
      Q3slide_2.setAutoDraw(true);
    }
    
    
    // if Q3slide_2 is active this frame...
    if (Q3slide_2.status === PsychoJS.Status.STARTED) {
    }
    
    
    // Check Q3slide_2 for response to end Routine
    if (Q3slide_2.getRating() !== undefined && Q3slide_2.status === PsychoJS.Status.STARTED) {
      continueRoutine = false; }
    ...
    // *QQ93* updates
    if (t >= 0.0 && QQ93.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      QQ93.tStart = t;  // (not accounting for frame time here)
      QQ93.frameNStart = frameN;  // exact frame index
      
      QQ93.setAutoDraw(true);
    }
    
    
    // if QQ93 is active this frame...
    if (QQ93.status === PsychoJS.Status.STARTED) {
    }
...
function SportQ5RoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'SportQ5' ---
    SportQ5Components.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    });
    psychoJS.experiment.addData('SportQ5.stopped', globalClock.getTime());
    psychoJS.experiment.addData('Q3slide_2.response', Q3slide_2.getRating());
    psychoJS.experiment.addData('Q3slide_2.rt', Q3slide_2.getRT());
    // the Routine "SportQ5" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
var Sport6MaxDurationReached;
var Sport6MaxDuration;
var Sport6Components;
function Sport6RoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'Sport6' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    ...
    Sport6Clock.reset();
    routineTimer.reset();
    Sport6MaxDurationReached = false;
    // update component parameters for each repeat
    textbox_Q6sport.setText('');
    textbox_Q6sport.refresh();
    QQ94.setText('第 94 题，共 97 题');
    psychoJS.experiment.addData('Sport6.started', globalClock.getTime());
    Sport6MaxDuration = null
    // keep track of which components have finished
    Sport6Components = [];
    Sport6Components.push(Q6sport);
    Sport6Components.push(textbox_Q6sport);
    Sport6Components.push(enter_hint_8);
    Sport6Components.push(QQ94);
    
    Sport6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Sport6RoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'Sport6' ---
    // get current time
    t = Sport6Clock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    
    // *Q6sport* updates
    if (t >= 0.0 && Q6sport.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q6sport.tStart = t;  // (not accounting for frame time here)
      Q6sport.frameNStart = frameN;  // exact frame index
      
      Q6sport.setAutoDraw(true);
    }
    
    
    // if Q6sport is active this frame...
    if (Q6sport.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *textbox_Q6sport* updates
    if (t >= 0.0 && textbox_Q6sport.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      textbox_Q6sport.tStart = t;  // (not accounting for frame time here)
      textbox_Q6sport.frameNStart = frameN;  // exact frame index
      
      textbox_Q6sport.setAutoDraw(true);
    }
    
    
    // if textbox_Q6sport is active this frame...
    if (textbox_Q6sport.status === PsychoJS.Status.STARTED) {
    }
    
    // Run 'Each Frame' code from code_Q6sport
    var _pj;
    function _pj_snippets(container) {
        function in_es6(left, right) {
            if (((right instanceof Array) || ((typeof right) === "string"))) {
    ...
    _pj = {};
    _pj_snippets(_pj);
    if ((! ("allow_advance_Q6" in psychoJS.experiment))) {
        psychoJS.experiment.allow_advance_Q6 = false;
    }
    keys = psychoJS.eventManager.getKeys();
    if (_pj.in_es6("return", keys)) {
        user_input = textbox_Q6sport.text.trim();
        if ((user_input !== "")) {
            psychoJS.experiment.allow_advance_Q6 = true;
        }
    }
    if (psychoJS.experiment.allow_advance_Q6) {
        continueRoutine = false;
    }
    ...
    // *QQ94* updates
    if (t >= 0.0 && QQ94.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      QQ94.tStart = t;  // (not accounting for frame time here)
      QQ94.frameNStart = frameN;  // exact frame index
      
      QQ94.setAutoDraw(true);
    }
    
    
    // if QQ94 is active this frame...
    if (QQ94.status === PsychoJS.Status.STARTED) {
    }
...
function Sport6RoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'Sport6' ---
    Sport6Components.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    });
    psychoJS.experiment.addData('Sport6.stopped', globalClock.getTime());
    psychoJS.experiment.addData('textbox_Q6sport.text',textbox_Q6sport.text)
    // Run 'End Routine' code from code_Q6sport
    psychoJS.experiment.addData("Q6_sport", textbox_Q6sport.text);
    
    // the Routine "Sport6" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
var SportQ7MaxDurationReached;
var SportQ7MaxDuration;
var SportQ7Components;
function SportQ7RoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'SportQ7' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    ...
    SportQ7Clock.reset();
    routineTimer.reset();
    SportQ7MaxDurationReached = false;
    // update component parameters for each repeat
    textbox_Q7sport.setText('');
    textbox_Q7sport.refresh();
    Q95.setText('第 95 题，共 97 题');
    psychoJS.experiment.addData('SportQ7.started', globalClock.getTime());
    SportQ7MaxDuration = null
    // keep track of which components have finished
    SportQ7Components = [];
    SportQ7Components.push(Q7sport);
    SportQ7Components.push(textbox_Q7sport);
    SportQ7Components.push(enter_hint_9);
    SportQ7Components.push(Q95);
    
    SportQ7Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SportQ7RoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'SportQ7' ---
    // get current time
    t = SportQ7Clock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    
    // *Q7sport* updates
    if (t >= 0.0 && Q7sport.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Q7sport.tStart = t;  // (not accounting for frame time here)
      Q7sport.frameNStart = frameN;  // exact frame index
      
      Q7sport.setAutoDraw(true);
    }
    
    
    // if Q7sport is active this frame...
    if (Q7sport.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *textbox_Q7sport* updates
    if (t >= 0.0 && textbox_Q7sport.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      textbox_Q7sport.tStart = t;  // (not accounting for frame time here)
      textbox_Q7sport.frameNStart = frameN;  // exact frame index
      
      textbox_Q7sport.setAutoDraw(true);
    }
    
    
    // if textbox_Q7sport is active this frame...
    if (textbox_Q7sport.status === PsychoJS.Status.STARTED) {
    }
    
    // Run 'Each Frame' code from code_Q7sport
    var _pj;
    function _pj_snippets(container) {
        function in_es6(left, right) {
            if (((right instanceof Array) || ((typeof right) === "string"))) {
    ...
    _pj = {};
    _pj_snippets(_pj);
    if ((! ("allow_advance_Q7" in psychoJS.experiment))) {
        psychoJS.experiment.allow_advance_Q7 = false;
    }
    keys = psychoJS.eventManager.getKeys();
    if (_pj.in_es6("return", keys)) {
        user_input = textbox_Q7sport.text.trim();
        if ((user_input !== "")) {
            psychoJS.experiment.allow_advance_Q7 = true;
        }
    }
    if (psychoJS.experiment.allow_advance_Q7) {
        continueRoutine = false;
    }
    
    
    // *enter_hint_9* updates
    if (t >= 0.0 && enter_hint_9.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      enter_hint_9.tStart = t;  // (not accounting for frame time here)
      enter_hint_9.frameNStart = frameN;  // exact frame index
      
      enter_hint_9.setAutoDraw(true);
    }
    
    
    // if enter_hint_9 is active this frame...
    if (enter_hint_9.status === PsychoJS.Status.STARTED) {
    }
...
function SportQ7RoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'SportQ7' ---
    SportQ7Components.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    });
    psychoJS.experiment.addData('SportQ7.stopped', globalClock.getTime());
    psychoJS.experiment.addData('textbox_Q7sport.text',textbox_Q7sport.text)
    // Run 'End Routine' code from code_Q7sport
    psychoJS.experiment.addData("Q7_sport", textbox_Q7sport.text);
    
    // the Routine "SportQ7" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
function BPAAT1RoutineBegin(snapshot) {
  return async function () {
    ...
    BPAAT1Components.push(Q96);
    BPAAT1Components.push(warningskip2_8);
...
function BPAAT1RoutineEachFrame() {
  return async function () {
    ...
    // *warningskip2_8* updates
    if (t >= 0.0 && warningskip2_8.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_8.tStart = t;  // (not accounting for frame time here)
      warningskip2_8.frameNStart = frameN;  // exact frame index
      
      warningskip2_8.setAutoDraw(true);
    }
    
    
    // if warningskip2_8 is active this frame...
    if (warningskip2_8.status === PsychoJS.Status.STARTED) {
    }
...
function BPAAT2RoutineBegin(snapshot) {
  return async function () {
    ...
    BPAAT2Components.push(Q97);
    BPAAT2Components.push(warningskip2_9);
...
function BPAAT2RoutineEachFrame() {
  return async function () {
    ...
    // *warningskip2_9* updates
    if (t >= 0.0 && warningskip2_9.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      warningskip2_9.tStart = t;  // (not accounting for frame time here)
      warningskip2_9.frameNStart = frameN;  // exact frame index
      
      warningskip2_9.setAutoDraw(true);
    }
    
    
    // if warningskip2_9 is active this frame...
    if (warningskip2_9.status === PsychoJS.Status.STARTED) {
    }
...
var endquitMaxDurationReached;
var endquitMaxDuration;
var endquitComponents;
function endquitRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'endquit' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // keep track of whether this Routine was forcibly ended
    ...
    endquitClock.reset();
    routineTimer.reset();
    endquitMaxDurationReached = false;
    // update component parameters for each repeat
    // reset exit_button_2 to account for continued clicks & clear times on/off
    exit_button_2.reset()
    textbox_end_2.setText('请务必点击下方"退出"按钮结束实验.\'');
    psychoJS.experiment.addData('endquit.started', globalClock.getTime());
    endquitMaxDuration = null
    // keep track of which components have finished
    endquitComponents = [];
    endquitComponents.push(background_8);
    endquitComponents.push(exit_button_2);
    endquitComponents.push(textbox_end_2);
    endquitComponents.push(text_hint_2);
    
    endquitComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function endquitRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'endquit' ---
    // get current time
    t = endquitClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    
    // *background_8* updates
    if (t >= 0.0 && background_8.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      background_8.tStart = t;  // (not accounting for frame time here)
    ...
    if (background_8.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (exit_button_2.status === PsychoJS.Status.STARTED) {
      ...
      if (exit_button_2.isClicked) {
        ...
        if (!exit_button_2.wasClicked) {
          ...
          continueRoutine = false;
          psychoJS.experiment.addData("quit", "\u6240\u6709\u5185\u5bb9\u5168\u90e8\u5b8c\u6210mark");
        }
    ...
    // *textbox_end_2* updates
    if (t >= 0.0 && textbox_end_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      textbox_end_2.tStart = t;  // (not accounting for frame time here)
      textbox_end_2.frameNStart = frameN;  // exact frame index
      
      textbox_end_2.setAutoDraw(true);
    }
    
    
    // if textbox_end_2 is active this frame...
    if (textbox_end_2.status === PsychoJS.Status.STARTED) {
    }
    
    
    // *text_hint_2* updates
    if (t >= 0.0 && text_hint_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      text_hint_2.tStart = t;  // (not accounting for frame time here)
      text_hint_2.frameNStart = frameN;  // exact frame index
      
      text_hint_2.setAutoDraw(true);
    }
    
    
    // if text_hint_2 is active this frame...
    if (text_hint_2.status === PsychoJS.Status.STARTED) {
    }
...
function endquitRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'endquit' ---
    endquitComponents.forEach( function(thisComponent) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    });
    psychoJS.experiment.addData('endquit.stopped', globalClock.getTime());
    ...
    // the Routine "endquit" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
